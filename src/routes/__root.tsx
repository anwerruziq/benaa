...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "شركة بناء للمقاولات — خبرة عشرين عاماً في البناء والتشييد والمقاولات العامة." },
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <div className="relative min-h-screen flex flex-col bg-background text-foreground" dir="rtl">
        <Navbar />
